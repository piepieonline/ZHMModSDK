...
inline void SetPropertyFromString(ZEntityRef entity, std::string propName, std::string propType, std::vector<std::string> values, int firstIndex, std::unordered_map<uint64_t, ZEntityRef>* knownEnts)
{
